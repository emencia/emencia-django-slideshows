...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SlideshowRandomImagePlugin.template'
        db.add_column(u'cmsplugin_slideshowrandomimageplugin', 'template',
                      self.gf('django.db.models.fields.CharField')(default='slideshows/random_slide/default.html', max_length=100),
                      keep_default=False)

        # Adding field 'SlideshowPlugin.template'
        db.add_column(u'cmsplugin_slideshowplugin', 'template',
                      self.gf('django.db.models.fields.CharField')(default='slideshows/slides_show/default.html', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SlideshowRandomImagePlugin.template'
        db.delete_column(u'cmsplugin_slideshowrandomimageplugin', 'template')

        # Deleting field 'SlideshowPlugin.template'
        db.delete_column(u'cmsplugin_slideshowplugin', 'template')
