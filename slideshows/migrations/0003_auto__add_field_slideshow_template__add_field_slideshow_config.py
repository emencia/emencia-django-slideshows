...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Slideshow.template'
        db.add_column('slideshows_slideshow', 'template',
                      self.gf('django.db.models.fields.CharField')(default='slideshows/default.html', max_length=100),
                      keep_default=False)

        # Adding field 'Slideshow.config'
        db.add_column('slideshows_slideshow', 'config',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Slideshow.template'
        db.delete_column('slideshows_slideshow', 'template')

        # Deleting field 'Slideshow.config'
        db.delete_column('slideshows_slideshow', 'config')
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 12, 0, 0)'}),
